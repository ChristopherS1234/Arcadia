...
<body class="admin-body">
    ...
    <section class="banner-2 justify-content-center align-items-center pt-5">
        <div>
            <h1 class="text">Espace d'administration service</h1>
    ...
    <section class="banner-2 justify-content-center align-items-center pt-5">
        <div>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" name="ajouter_image">Ajouter</button>
            </form>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" enctype="multipart/form-data" style="display:inline;">
                                    ...
                                    <button type="submit" name="modifier_image">Modifier</button>
                                </form>
    ...
    <section class="banner-2 justify-content-center align-items-center pt-5">
        <div>
            ...
            <form method="POST">
                <input type="text" name="nom" placeholder="nom" required>
                <textarea name="description" placeholder="Description" required></textarea>
                <button type="submit" name="ajouter2">Ajouter</button>
            </form>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" style="display:inline;">
                                    ...
                                    <input type="text" name="nom" value="<?= htmlspecialchars($contenu['nom']) ?>" required>
                                    <textarea name="description" required><?= htmlspecialchars($contenu['description']) ?></textarea>
                                    <button type="submit" name="modifier2">Modifier</button>
                                </form>
    ...
    <section class="banner-2 justify-content-center align-items-center pt-5">
        <div>
            ...
            <form method="POST" enctype="multipart/form-data">
                <input type="file" name="image" accept="image/*" required>
                <button type="submit" name="ajouter_image_sec">Ajouter</button>
            </form>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" enctype="multipart/form-data" style="display:inline;">
                                    <input type="hidden" name="id" value="<?= $image['image_id'] ?>">
                                    <input type="file" name="nouvelle_image" accept="image/*" required>
                                    <button type="submit" name="modifier_image_sec">Modifier</button>
                                </form>
    ...
    <section class="banner-2 justify-content-center align-items-center pt-5">
        <div>
            ...
            <form method="POST">
                <input type="text" name="nom" placeholder="nom" required>
                <textarea name="description" placeholder="Description" required></textarea>
                <button type="submit" name="ajouter3">Ajouter</button>
            </form>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" style="display:inline;">
                                    ...
                                    <input type="text" name="nom" value="<?= htmlspecialchars($contenu['nom']) ?>" required>
                                    <textarea name="description" required><?= htmlspecialchars($contenu['description']) ?></textarea>
                                    <button type="submit" name="modifier3">Modifier</button>
                                </form>
    ...
    <section class="banner-2 justify-content-center align-items-center pt-5">
        <div>
            ...
            <form method="POST" enctype="multipart/form-data">
                <input type="file" name="image" accept="image/*" required>
                <button type="submit" name="ajouter_image_third">Ajouter</button>
            </form>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" enctype="multipart/form-data" style="display:inline;">
                                    <input type="hidden" name="id" value="<?= $image['image_id'] ?>">
                                    <input type="file" name="nouvelle_image" accept="image/*" required>
                                    <button type="submit" name="modifier_image_third">Modifier</button>
                                </form>
