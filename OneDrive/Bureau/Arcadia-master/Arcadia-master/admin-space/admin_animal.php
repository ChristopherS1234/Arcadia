...
<body class="admin-body">
    ...
    <section class="banner-2 justify-content-center align-items-center pt-5">
        <div>
            <h1 class="text">Espace d'administration des animaux</h1>

            <h2 class="text">Ajouter un animal pour pouvoir rester informé de l'état des animaux du Zoo</h2>
            <form method="POST">
                <input type="text" name="prenom" placeholder="prenom" required>
                <input type="text" name="label" placeholder="label" required>
                <textarea name="etat" placeholder="etat" required></textarea>
                <button type="submit" name="ajouter_animal">Ajouter</button>
            </form>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" style="display:inline;">
                                    ...
                                    <input type="text" name="prenom" value="<?= htmlspecialchars($contenu['prenom']) ?>" required>
                                    <input type="text" name="race" value="<?= htmlspecialchars($contenu['race']) ?>" required>
                                    <textarea name="etat" required><?= htmlspecialchars($contenu['etat']) ?></textarea>
