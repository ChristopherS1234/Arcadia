...
<body class="admin-body">
    ...
    <section class="banner-2 justify-content-center align-items-center pt-5">
        <div class="admin-container">
            ...
            <h2 class="text">Ici vous pouvez ajouter le 1er pargraphe de l'accueil</h2>
    ...
    <section class="banner-2 justify-content-center align-items-center pt-5">
        <div>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" name="ajouter_image_accueil">Ajouter</button>
            </form>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" enctype="multipart/form-data" style="display:inline;">
                                    ...
                                    <button type="submit" name="modifier_image_accueil">Modifier</button>
                                </form>
