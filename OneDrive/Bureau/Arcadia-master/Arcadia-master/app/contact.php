...
<body>
    ...
    <section class="banner-2 d-flex justify-content-center align-items-center pt-5">
        <div class="form-container">
            <h1 class="text">Contactez-nous</h1>
            <h5 class="text">Envoyez-nous votre message et nous vous répondrons dans les plus brefs délais par mail.</h5>
            ...
            <form method="POST">
                <label for="mail" class="text">Mail* :</label>
