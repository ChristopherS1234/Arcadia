    ...
    <div>
            <p>
                <button class="btn btn-success">
                    <a class="nav-link active" href="./habitat-1.php">< Précédent</a>
                </button>
            </p>
        </div>
        <div class="single-image">
            ...
            $stmt = $pdo->query("SELECT * FROM image_habitat_sec ORDER BY image_id DESC LIMIT 1");
        ...
        <div>
            <p>
                <button class="btn btn-success">
                    <a class="nav-link active" href="./habitat-3.php">Suivant ></a>
                </button>
            </p>
        </div>

    </section>
    <?php if (!empty($habitat_sec)): ?>
