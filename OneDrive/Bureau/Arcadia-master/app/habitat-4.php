...
<body>
    ...
    <section class="summary-2 d-flex justify-content-center align-items-center pt-5">
        ...
        <div class="single-image-h">
            ...
            $stmt = $pdo->query("SELECT * FROM image_habitat_last ORDER BY image_id DESC LIMIT 1");
                    ...
                    <div>
                        <p>
                            <button class="btn btn-success">
                                <a class="nav-link active" href="./habitat-4.php">
                                    < Précédent</a>
                            </button> 
                            <button class="btn btn-success">
                                <a class="nav-link active" href="./habitat-2.php">Suivant ></a>
                            </button>
                        </p>
                    </div>
                    <div class="avis-card">
