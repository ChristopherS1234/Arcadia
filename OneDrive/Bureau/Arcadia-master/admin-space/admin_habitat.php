        ...
        <div class="admin-container">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" style="display:inline;">
                                        ...
                                        <button type="submit" class="btn btn-success" name="modifier_habitat">Modifier</button>
                                    </form>
            ...
            <div class="admin-card">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-success" name="ajouter_image_habitat">Ajouter</button>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" enctype="multipart/form-data" style="display:inline;">
                                        ...
                                        <button type="submit" class="btn btn-success" name="modifier_image_habitat">Modifier</button>
                                    </form>
            ...
            <div class="admin-card">
                ...
                <form method="POST">
                    ...
                    <button type="submit" class="btn btn-success" name="habitat_ajouter_sec">Ajouter</button>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" style="display:inline;">
                                        ...
                                        <input type="text" name="description" value="<?= htmlspecialchars($contenu['description']) ?>" required>
                                        <textarea name="commentaire_habitat" required><?= htmlspecialchars($contenu['commentaire_habitat']) ?></textarea>
                                        <button type="submit" class="btn btn-success" name="modifier_habitat_sec">Modifier</button>
                                    </form>
            ...
            <div class="admin-card">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <input type="file" class="text" name="image" accept="image/*" required>
                    <button type="submit" class="btn btn-success" name="ajouter_image_habitat_sec">Ajouter</button>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" enctype="multipart/form-data" style="display:inline;">
                                        <input type="hidden" name="id" value="<?= $image['image_id'] ?>">
                                        <input type="file" name="nouvelle_image" accept="image/*" required>
                                        <button type="submit" class="btn btn-success" name="modifier_image_habitat_sec">Modifier</button>
                                    </form>
            ...
            <div class="admin-card">
                ...
                <form method="POST">
                    ...
                    <button type="submit" class="btn btn-success" name="habitat_ajouter_third">Ajouter</button>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" style="display:inline;">
                                        ...
                                        <input type="text" name="description" value="<?= htmlspecialchars($contenu['description']) ?>" required>
                                        <textarea name="commentaire_habitat" required><?= htmlspecialchars($contenu['commentaire_habitat']) ?></textarea>
                                        <button type="submit" class="btn btn-success" name="modifier_third_habitat">Modifier</button>
                                    </form>
            ...
            <div class="admin-card">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <input type="file" class="text" name="image" accept="image/*" required>
                    <button type="submit" class="btn btn-success" name="ajouter_image_habitat_third">Ajouter</button>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" enctype="multipart/form-data" style="display:inline;">
                                        <input type="hidden" name="id" value="<?= $image['image_id'] ?>">
                                        <input type="file" name="nouvelle_image" accept="image/*" required>
                                        <button type="submit" class="btn btn-success" name="modifier_image_habitat_third">Modifier</button>
                                    </form>
            ...
            <div class="admin-card">
                ...
                <form method="POST">
                    ...
                    <button type="submit" class="btn btn-success" name="habitat_ajouter_last">Ajouter</button>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" style="display:inline;">
                                        ...
                                        <input type="text" name="description" value="<?= htmlspecialchars($contenu['description']) ?>" required>
                                        <textarea name="commentaire_habitat" required><?= htmlspecialchars($contenu['commentaire_habitat']) ?></textarea>
                                        <button type="submit" class="btn btn-success" name="modifier_last_habitat">Modifier</button>
                                    </form>
            ...
            <div class="admin-card">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <input type="file" class="text" name="image" accept="image/*" required>
                    <button type="submit" class="btn btn-success" name="ajouter_image_habitat_last">Ajouter</button>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" enctype="multipart/form-data" style="display:inline;">
                                        <input type="hidden" name="id" value="<?= $image['image_id'] ?>">
                                        <input type="file" name="nouvelle_image" accept="image/*" required>
                                        <button type="submit" class="btn btn-success" name="modifier_image_habitat_last">Modifier</button>
                                    </form>
