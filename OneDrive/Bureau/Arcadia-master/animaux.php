...
<body>
                ...
                <div class="col-md 6">
                    ...
                    <h5 class="text">
                        ...
                        <h5>
                            <ul>
                                <p>
                                    <button class="btn btn-success" onclick="trackClickAndGo('animaux', 'bouton_lion', './pages-animaux/lion.php')">
                                        Le Lion
                                    </button>
                                </p>
                                <p>
                                    <button class="btn btn-success" onclick="trackClickAndGo('animaux', 'bouton_girafe', './pages-animaux/girafe.php')">
                                        La Girafe
                                    </button>
                                </p>
                                <p>
                                    <button class="btn btn-success" onclick="trackClickAndGo('animaux', 'bouton_cerf', './pages-animaux/cerf.php')">
                                        Le Cerf
                                    </button>
                                </p>
                                <p>
                                    <button class="btn btn-success" onclick="trackClickAndGo('animaux', 'bouton_loup', './pages-animaux/loup.php')">
                                        Le Loup
                                    </button>
                                </p>
                                <p>
                                    <button class="btn btn-success" onclick="trackClickAndGo('animaux', 'bouton_singe', './pages-animaux/singe.php')">
                                        Le Singe
                                    </button>
                                </p>
                                <p>
                                    <button class="btn btn-success" onclick="trackClickAndGo('animaux', 'bouton_serpent', './pages-animaux/serpent.php')">
                                        Le Serpent
                                    </button>
                                </p>
                                <p>
                                    <button class="btn btn-success" onclick="trackClickAndGo('animaux', 'bouton_polair', './pages-animaux/polair.php')">
                                        L'Ours Polaire
                                    </button>
                                </p>
                            </ul>
    ...
    <script>
        function trackClickAndGo(pageName, elementName, urlRedirect) {
            fetch('./admin-space/track_clicks.php', {
                ...
                // Rediriger après le clic, qu'il réussisse ou non
