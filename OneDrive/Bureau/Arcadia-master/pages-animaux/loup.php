...
<body>
    ...
    <section class="banner-2 d-flex justify-content-center align-items-center pt-5">
        <div class="single-image">
            <img src="../image/loup.jpg" alt="Image principale">
        </div>
        ...
        <div class="container my-5 py-5">
            <div class="row">
                ...
                <div class="col-md 6">
                    ...
                    <h5 class="text">
                        Animal emblématique des légendes et des contes, le loup est un prédateur social qui vit en meute hiérarchisée. Chasseur habile et intelligent, il se nourrit principalement de cervidés et de petits mammifères. Contrairement aux idées reçues, il évite les humains et joue un rôle essentiel dans l’équilibre des écosystèmes en régulant les populations d’herbivores. Au zoo Arcadia, les loups disposent d’un vaste territoire boisé où ils peuvent exprimer leurs comportements naturels, comme la chasse et la communication par hurlements. Les visiteurs ont la chance d’observer ces fascinants canidés interagir entre eux et renforcer les liens sociaux. Longtemps persécuté, le loup est aujourd’hui protégé dans plusieurs régions du monde. Arcadia sensibilise les visiteurs à son importance écologique et aux efforts de réintroduction dans certaines zones sauvages.
                        <h5>
                            <p>
    ...
    <section class="banner d-flex justify-content-center align-items-center pt-5">
        <div class="container my-5 py-5">
            <div class="row">
                ...
                <p>
                    <button class="btn btn-success"><a class="nav-link active" href="../app/habitat-3.php"> Cliquez ici pour avoir la Réponse</a></button>
                </p>
            </div>
        </div>
        </div>
